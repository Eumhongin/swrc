<?php
    ...
    var $row;
		...
		function Connect(){
      $this->conn = new mysqli($this->db_host,$this->mysql_id,$this->mysql_passwd,$this->db_name);
      return $this->conn;
		}
		...
		function ParseExec($qry){
			...
			$this->stmt = mysqli_query($this->conn,$qry);
		...
		function FetchInto(&$col){
      $col = mysqli_fetch_array($this->stmt,MYSQL_ASSOC);
      return $col ;
    }
