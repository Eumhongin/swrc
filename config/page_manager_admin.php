<?php
	...
	class initPage
	{
		...
		{
			return $this->getPageListA($pageURL, $parameter, $total, $WidthPageList, "<img src=\"/pages/admin/images/bbs/page_prev.gif\" >", "<img src=/pages/admin/images/bbs/page_next.gif >" );
		}
